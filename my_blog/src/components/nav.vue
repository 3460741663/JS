    ...
    <div class="nav">
      <div class="nav-content">
        <el-row :gutter="20">
          ...
          <el-col :span="5">
            <div class="nav-right">
              <el-button type="primary" size="small" @click="handleClick('login')" round>登录</el-button>
              <el-button type="danger" size="small" @click="handleClick('register')" round>注册</el-button>
            </div>
          </el-col>
        </el-row>
      </div>
